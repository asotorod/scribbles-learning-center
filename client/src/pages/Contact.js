              ...
              <div className="info-card location-card">
                ...
                <div className="location-features">
                  <div className="location-feature">
                    ...
                    <div>
                      <strong>Shopping Plaza Location</strong>
                      <p>Located in a convenient shopping plaza with easy access</p>
                    </div>
                  </div>
                  <div className="location-feature">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      <path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9L18 10l-1.2-4H8.4L7 7v10"/>
                      <circle cx="9" cy="17" r="2"/>
                      <path d="M14 17h-3"/>
                    </svg>
                    <div>
                      <strong>Free Parking</strong>
                      <p>Dedicated parking lot for easy drop-off and pick-up</p>
                    </div>
                  </div>
                  <div className="location-feature">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      ...
                      <path d="M15 6v6"/>
                      <path d="M2 12h19.6"/>
                      <path d="M18 18h3s.5-1.7.8-2.8c.1-.4.2-.8.2-1.2 0-.4-.1-.8-.2-1.2L21 10H3l-.8 2.8c-.1.4-.2.8-.2 1.2 0 .4.1.8.2 1.2.3 1.1.8 2.8.8 2.8h3"/>
                      <circle cx="7" cy="18" r="2"/>
                      <circle cx="17" cy="18" r="2"/>
                    </svg>
                    <div>
                      <strong>Public Transit Accessible</strong>
                      <p>Near NJ Transit bus routes for commuter convenience</p>
                    </div>
                  </div>
                  <div className="location-feature">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <div>
                      <strong>Waterfront Community</strong>
                      <p>Beautiful Edgewater location along the Hudson River</p>
                    </div>
                  </div>
                </div>
              </div>
